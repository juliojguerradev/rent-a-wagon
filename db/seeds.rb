...
User.all.each do |user|
  2.times do
    car = Vehicle.new(name: Faker::Vehicle.make_and_model, description: "a good car", model: Faker::Vehicle.model, brand: Faker::Vehicle.make, rent_cost_per_day: (10..20).to_a.sample, address: Faker::Address.street_address)
    car.user = user
    car.save
  end
end
